...
<div class="page-header breadcrumb-wrap">
    <div class="container">
        <div class="breadcrumb">
            ...
            <span></span> <a href="{{ route('blogs') }}">Blogs</a> <span></span> Blog Post
        </div>
    </div>
</div>
                            ...
                            <div class="single-header style-2">
                                <div class="row">
                                    <div class="col-xl-10 col-lg-12 m-auto">
                                        <h3 class="mb-10">{{ $blog->title }}</h3>
                                        <span class="post-on has-dot">{{ $blog->created_at->format('d F Y')}}</span>
                                    ...
                                    <div class="row">
                                    <div class="col-xl-10 col-lg-12 m-auto">
                                        <p class="single-excerpt">{!! $blog->long_description !!}</p>
                        ...
                        <div class="widget-area">
                            ...
                            <div class="sidebar-widget widget-category-2 mb-50">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="shop-grid-right.html"> <img src="assets/imgs/theme/icons/category-1.svg" alt="" />{{ $item->category_name }}</a><span class="count">{{ count($item->BlogPost) }}</span>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <div class="sidebar-widget product-sidebar mb-50 p-30 bg-grey border-radius-10">
                                ...
                                <div class="single-post clearfix">
                                    ...
                                    <div class="content pt-10">
                                        <h6><a href="shop-product-detail.html">{{ ucfirst($item->product_name )}}</a></h6>
                                        @php
