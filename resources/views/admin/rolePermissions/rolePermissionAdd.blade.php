...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">New Permission</div>
        <div class="ps-3">
    ...
    <div class="card">
        <div class="card-body">
          <form action="{{ route('adminRolePermissionAssign') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            <div class="row mb-3">
              <div class="col-sm-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9 text-secondary">
                  ...
                  <div class="form-check">
                      <input class="form-check-input permission-checkbox" name="permission_ids[]" type="checkbox" value="{{ $permission->id }}" id="{{ $permission->id }}">
