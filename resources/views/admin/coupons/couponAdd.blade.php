...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">New Coupon</div>
        <div class="ps-3">
    ...
    <div class="card">
        <div class="card-body">
          <form action="{{ route('adminCouponSave') }}" method="POST" enctype='multipart/form-data' class="needs-validation" novalidate>
            @csrf
            <div class="row mb-3">
              <div class="col-sm-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9 text-secondary">
                <input type="text" name="coupon_discount" class="form-control" placeholder="0%" required>
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9 text-secondary">
                <input type="date" name="coupon_validity" class="form-control" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" required>
