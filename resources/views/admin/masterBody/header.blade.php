        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center">
                    ...
                    <li class="nav-item dropdown dropdown-large">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> <span class="alert-count">{{ count($admin->unreadNotifications) }}</span>
                                ...
                                <div class="header-notifications-list">
                                    @foreach ($admin->notifications as $notification)
                                        @if ($notification->type == 'App\Notifications\VendorNotification')
                                            <a class="dropdown-item"  href="{{ route('inactiveVendors'), $notification->markAsRead() }}">
                                                @php
                                                    $message = 'Vendor Request';
                                                    $icon = '<div class="notify bg-light-success text-success"><i class="bx bx-group"></i></div>';
                                                @endphp
                                        @elseif ($notification->type == 'App\Notifications\OrderNotification')
                                            <a class="dropdown-item" href="{{ route('adminOrdersPending'), $notification->markAsRead() }}">
                                                @php
                                                    $message = 'New Order';
                                                    $icon = '<div class="notify bg-light-danger text-danger"><i class="bx bx-cart-alt"></i></div>';
                                                @endphp
                                        @endif
                                            <div class="d-flex align-items-center">
                                                {!! $icon !!}
                                                <div class="flex-grow-1">
                                                    <h6 class="msg-name">{{ $message }} <span class="msg-time float-end">{{ $notification->created_at->diffForHumans() }}</span></h6>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ empty( $user->image ) ? asset('backend/assets/images/no_image.jpg') : asset('images/users/' . $user->image) }}" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('passwordChange') }}"><i class="bx bx-lock"></i><span>Change Password</span></a>
                    </li>
