...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <a href="{{ route('adminBlogCategoriesAll') }}" class="btn btn-primary">Back</a>
        </div>
    </div>
    <!--end breadcrumb-->
    <div class="card">
        <div class="card-body">
          <form action="{{ route('adminBlogCategoryUpdate') }}" method="POST" class="needs-validation" novalidate>
            @csrf
            @method('put')
            <div class="row mb-3">
              <div class="col-sm-3">
              ...
              <div class="col-sm-9 text-secondary">
                ...
                <input type="text" name="category_name" class="form-control" required value="{{ $blogCategory->category_name }}"/>
            ...
            <div class="row">
              ...
              <div class="col-sm-9 text-secondary">
                <button type="submit" class="btn btn-primary px-4">Update Blog Category</button>
              </div>
            </div>
          </form>
