...
<div class="page-content">
    ...
    <div class="card">
      <div class="card-body p-4">
        <form method="POST" action="{{ route('vendorProductSave') }}" enctype='multipart/form-data' class="needs-validation" novalidate>
          @csrf
          <div class="row">
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
              <div class="border border-3 p-4 rounded">
                <div class="row g-3">
                  ...
                  <input type="text" class="form-control" name="discount" id="inputCompareatprice" placeholder="00.00" required>
